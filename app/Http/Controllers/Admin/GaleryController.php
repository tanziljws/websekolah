...
class GaleryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.galery.create', compact('posts', 'categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $galery = Galery::create([
            ...
            'position' => 0, // Default value karena masih ada di migration
        ]);
    ...
    public function edit(Galery $galery)
    {
        $posts = Post::with('kategori')->where('status', 'published')->get();
        $categories = Kategori::all();
        return view('admin.galery.edit', compact('galery', 'posts', 'categories'));
    }
    ...
    public function update(Request $request, Galery $galery)
    {
        ...
        $galery->update([
            ...
            // position tidak diupdate, tetap menggunakan existing value
        ]);
