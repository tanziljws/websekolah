...
class FotoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('files')) {
            ...
            // Redirect ke galeri show setelah upload
            $galery = Galery::find($validated['galery_id']);
            return redirect()->route('admin.galery.show', $galery)
        ...
        if ($request->expectsJson()) {
            return response()->json([
                'success' => true,
                'uploaded' => 1,
                'redirect' => route('admin.galery.show', $galery),
    ...
    public function update(Request $request, Foto $foto)
    {
        ...
        // Redirect kembali ke galeri show
        return redirect()->route('admin.galery.show', $foto->galery)
    ...
    public function destroy(Foto $foto)
    {
        ...
        $galeryId = $foto->galery_id;
        $foto->delete();

        // Redirect kembali ke galeri show
        return redirect()->route('admin.galery.show', $galeryId)
