...
@section('title', 'Detail Agenda - Admin')
@section('page-title', 'Detail Agenda')

@section('content')
<div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
    <div class="mb-6">
        <a href="{{ route('admin.agenda.index') }}" class="text-pink-primary hover:text-pink-dark">← Kembali</a>
    </div>
    ...
    <div class="flex space-x-4">
        <a href="{{ route('admin.agenda.edit', $post) }}" class="px-6 py-2 bg-pink-primary text-white rounded-lg hover:bg-pink-dark transition">Edit</a>
        ...
        <a href="{{ route('admin.agenda.index') }}" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition">Kembali</a>
    </div>
</div>
@endsection
