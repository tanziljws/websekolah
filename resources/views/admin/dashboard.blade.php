...
@section('title', 'Dashboard Admin - Web Galeri Sekolah')
    ...
    <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900 mt-2">{{ $totalPetugas }}</p>
            </div>
            <div class="w-12 h-12 bg-pink-light rounded-full flex items-center justify-center">
                <svg class="w-6 h-6 text-pink-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('admin.posts.index') }}" class="text-pink-primary hover:text-pink-dark font-medium">Lihat Semua →</a>
    </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        ...
        <div class="h-64 flex items-end justify-around space-x-2">
            ...
            <div class="flex-1 flex flex-col items-center">
                <div class="w-full bg-gray-200 rounded-t-lg flex items-end" style="height: 200px;">
                    <div class="w-full bg-green-500 rounded-t-lg transition-all duration-500" style="height: {{ ($publishedCount / $maxCount) * 100 }}%"></div>
                </div>
            ...
            <div class="flex-1 flex flex-col items-center">
                <div class="w-full bg-gray-200 rounded-t-lg flex items-end" style="height: 200px;">
                    <div class="w-full bg-gray-500 rounded-t-lg transition-all duration-500" style="height: {{ ($draftCount / $maxCount) * 100 }}%"></div>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
        ...
        <div class="h-64 flex items-end justify-around space-x-2">
            ...
            <div class="flex-1 flex flex-col items-center">
                <div class="w-full bg-gray-200 rounded-t-lg flex items-end" style="height: 200px;">
                    <div class="w-full bg-pink-primary rounded-t-lg transition-all duration-500" style="height: {{ ($activeGaleries / $maxGaleries) * 100 }}%"></div>
                </div>
                <p class="mt-2 text-sm font-medium text-gray-700">Aktif</p>
                <p class="text-2xl font-bold text-gray-900">{{ $activeGaleries }}</p>
            </div>
            <div class="flex-1 flex flex-col items-center">
                <div class="w-full bg-gray-200 rounded-t-lg flex items-end" style="height: 200px;">
                    <div class="w-full bg-gray-500 rounded-t-lg transition-all duration-500" style="height: {{ ($inactiveGaleries / $maxGaleries) * 100 }}%"></div>
                </div>
                <p class="mt-2 text-sm font-medium text-gray-700">Nonaktif</p>
                <p class="text-2xl font-bold text-gray-900">{{ $inactiveGaleries }}</p>
            </div>
        </div>
    </div>
</div>
