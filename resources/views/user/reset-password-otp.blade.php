...
@section('title', 'Verifikasi OTP Reset Password - SMKN 4 BOGOR')
...
<section class="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-white to-pink-50 py-12 px-4">
    ...
    <div class="max-w-md w-full relative z-10">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600">Masukkan kode OTP yang telah dikirim ke email Anda untuk reset password</p>
        </div>
        
        <!-- Reset Password OTP Card -->
        <div class="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-100 p-8 md:p-10">
            ...
            <form action="{{ route('user.reset-password-otp.verify') }}" method="POST" class="space-y-6">
                @csrf
            ...
            <!-- Resend OTP -->
            <form action="{{ route('user.reset-password-otp.resend') }}" method="POST" class="mt-6 text-center">
                @csrf
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('user.forgot-password') }}" class="inline-flex items-center text-gray-600 hover:text-pink-primary transition-colors text-sm font-medium">
