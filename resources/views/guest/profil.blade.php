    ...
    <div class="container mx-auto px-4">
        <div class="max-w-5xl mx-auto text-center">
            <div class="flex justify-center mb-6">
                <img src="{{ asset('logo.png') }}" alt="SMKN 4 BOGOR" class="h-32 w-auto object-contain">
            </div>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="mb-12 text-center border-b border-gray-200 pb-8">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">{{ $profile->judul ?? 'Profil Sekolah' }}</h2>
            ...
            <div class="prose prose-lg max-w-none">
                ...
                @foreach($paragraphs as $index => $paragraph)
                    ...
                    <div class="mb-8 p-6 bg-gray-50 rounded-xl border border-gray-200 hover:border-pink-primary transition-colors duration-300">
                        <p class="text-gray-700 leading-relaxed text-lg whitespace-pre-line">{{ trim($paragraph) }}</p>
                    </div>
                    @endif
                @endforeach
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-2xl mx-auto text-center">
            <div class="bg-gray-50 rounded-2xl p-12 border border-gray-200">
                ...
                <a href="{{ route('guest.home') }}" class="inline-flex items-center px-6 py-3 bg-pink-primary text-white rounded-lg hover:bg-pink-dark transition font-medium">
        ...
        <div class="max-w-5xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                    ...
                    <a href="{{ route('guest.kontak') }}" class="inline-flex items-center mt-4 text-pink-primary hover:text-pink-dark font-medium">
                        Lihat Kontak
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                    ...
                    <a href="{{ route('guest.galeri') }}" class="inline-flex items-center mt-4 text-pink-primary hover:text-pink-dark font-medium">
                        Lihat Galeri
                        <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                    ...
                    <a href="{{ route('guest.informasi') }}" class="inline-flex items-center mt-4 text-pink-primary hover:text-pink-dark font-medium">
                        Lihat Informasi
                        <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
