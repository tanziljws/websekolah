...
@section('title', $post->judul . ' - Informasi')

@section('content')
<section class="py-12 bg-white">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            <a href="{{ route('guest.informasi') }}" class="text-pink-primary hover:text-pink-dark mb-4 inline-block">← Kembali ke Informasi</a>
            ...
            <article class="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
                ...
                <div class="flex items-center flex-wrap gap-3 text-gray-600 mb-6 border-b border-gray-200 pb-4">
                    ...
                    <span>•</span>
                    <div class="flex items-center space-x-1 bg-pink-50 px-3 py-1 rounded-full">
                        ...
                        <span class="font-semibold text-pink-primary">{{ number_format($post->total_visitors ?? 0) }}</span>
                ...
                <div class="mt-8 p-6 bg-pink-light rounded-lg border border-pink-200">
                    ...
                    <p class="text-gray-700 mb-4">Informasi ini memiliki galeri foto terkait:</p>
            ...
            <div class="mt-12">
                <h2 class="text-2xl font-bold text-gray-900 mb-6">Informasi Lainnya</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    @foreach($relatedPosts as $related)
                    <a href="{{ route('guest.informasi.show', $related) }}" class="block bg-white rounded-lg shadow-md hover:shadow-xl transition p-6 border border-gray-200">
