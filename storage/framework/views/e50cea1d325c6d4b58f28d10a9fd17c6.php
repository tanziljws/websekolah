<?php $__env->startSection('title', 'Informasi Terkini - Web Galeri Sekolah'); ?>
...
<section class="py-12 bg-white">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="<?php echo e(route('guest.informasi.show', $post)); ?>" class="block bg-white rounded-lg shadow-md hover:shadow-xl transition overflow-hidden border border-gray-200">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/tanziljws/Documents/backend/resources/views/guest/informasi/index.blade.php ENDPATH**/ ?>