<?php $__env->startSection('title', 'Login - SMKN 4 BOGOR'); ?>
        ...
        <div class="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-100 p-8 md:p-10">
            ...
            <form action="<?php echo e(route('user.login')); ?>" method="POST" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('user.forgot-password')); ?>" class="text-sm font-medium text-pink-primary hover:text-pink-dark transition-colors">
                        Lupa password?
                    </a>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/tanziljws/Documents/backend/resources/views/user/login.blade.php ENDPATH**/ ?>