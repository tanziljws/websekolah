<?php $__env->startSection('title', 'Kelola Homepage - Admin Panel'); ?>
<?php $__env->startSection('page-title', 'Kelola Konten Homepage'); ?>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
            ...
            <form id="visi-form">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="content" id="visi-content" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-pink-primary focus:border-transparent resize-none" placeholder="Masukkan visi sekolah..."><?php echo e($visi->content ?? 'Menjadi sekolah "tangguh dalam IMTAQ, cerdas, terampil, mandiri, berbasis Teknologi Informasi dan Komunikasi, dan berwawasan lingkungan."'); ?></textarea>
                </div>
            </form>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
            ...
            <div id="misi-items" class="space-y-3">
                <?php if($misi && $misi->count() > 0): ?>
                    ...
                    <div class="flex items-start space-x-3" data-misi-id="<?php echo e($item->id); ?>">
                        <input type="text" name="misi_content" value="<?php echo e($item->content); ?>" class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-primary focus:border-transparent" onchange="updatePreview('misi', <?php echo e($index); ?>)">
                        <button onclick="deleteMisi(<?php echo e($item->id); ?>)" class="px-3 py-2 text-red-600 hover:bg-red-50 rounded-lg transition">
            ...
            <div id="prestasi-tab" class="tab-content space-y-4">
                ...
                <div id="prestasi-items" class="space-y-3">
                    <?php if($prestasi && $prestasi->count() > 0): ?>
                        ...
                        <div class="border border-gray-200 rounded-xl p-4" data-item-id="<?php echo e($item->id); ?>">
                            <input type="text" name="title" value="<?php echo e($item->title); ?>" placeholder="Judul" class="w-full mb-2 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-primary" onchange="updatePreview('prestasi', <?php echo e($index); ?>)">
                            <textarea name="content" rows="2" placeholder="Deskripsi" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-primary resize-none" onchange="updatePreview('prestasi', <?php echo e($index); ?>)"><?php echo e($item->content); ?></textarea>
                            <div class="flex justify-end mt-2 space-x-2">
                                <button onclick="saveContentItem(<?php echo e($item->id); ?>)" class="px-3 py-1 text-sm bg-pink-primary text-white rounded-lg hover:bg-pink-dark transition">Simpan</button>
                                <button onclick="deleteContentItem(<?php echo e($item->id); ?>)" class="px-3 py-1 text-sm bg-red-500 text-white rounded-lg hover:bg-red-600 transition">Hapus</button>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
            ...
            <div id="program-tab" class="tab-content hidden space-y-4">
                ...
                <div id="program-items" class="space-y-3">
                    <?php if($programs && $programs->count() > 0): ?>
                        <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="border border-gray-200 rounded-xl p-4" data-item-id="<?php echo e($item->id); ?>">
                            <input type="text" name="title" value="<?php echo e($item->title); ?>" placeholder="Nama Program" class="w-full mb-2 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-primary" onchange="updatePreview('program', <?php echo e($index); ?>)">
                            <textarea name="content" rows="2" placeholder="Deskripsi" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-primary resize-none" onchange="updatePreview('program', <?php echo e($index); ?>)"><?php echo e($item->content); ?></textarea>
                            <div class="flex justify-end mt-2 space-x-2">
                                <button onclick="saveContentItem(<?php echo e($item->id); ?>)" class="px-3 py-1 text-sm bg-pink-primary text-white rounded-lg hover:bg-pink-dark transition">Simpan</button>
                                <button onclick="deleteContentItem(<?php echo e($item->id); ?>)" class="px-3 py-1 text-sm bg-red-500 text-white rounded-lg hover:bg-red-600 transition">Hapus</button>
                            </div>
            ...
            <div id="fasilitas-tab" class="tab-content hidden space-y-4">
                ...
                <div id="fasilitas-items" class="space-y-3">
                    <?php if($fasilitas && $fasilitas->count() > 0): ?>
                        ...
                        <div class="border border-gray-200 rounded-xl p-4" data-item-id="<?php echo e($item->id); ?>">
                            <input type="text" name="title" value="<?php echo e($item->title); ?>" placeholder="Nama Fasilitas" class="w-full mb-2 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-primary" onchange="updatePreview('fasilitas', <?php echo e($index); ?>)">
                            <textarea name="content" rows="2" placeholder="Deskripsi" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-primary resize-none" onchange="updatePreview('fasilitas', <?php echo e($index); ?>)"><?php echo e($item->content); ?></textarea>
                            <div class="flex justify-end mt-2 space-x-2">
                                <button onclick="saveContentItem(<?php echo e($item->id); ?>)" class="px-3 py-1 text-sm bg-pink-primary text-white rounded-lg hover:bg-pink-dark transition">Simpan</button>
                                <button onclick="deleteContentItem(<?php echo e($item->id); ?>)" class="px-3 py-1 text-sm bg-red-500 text-white rounded-lg hover:bg-red-600 transition">Hapus</button>
                            </div>
    ...
    <div class="lg:sticky lg:top-6 lg:h-screen lg:overflow-y-auto">
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('guest.home')); ?>" target="_blank" class="px-4 py-2 text-sm bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition font-medium">
                    Lihat di Website
                </a>
            </div>
            ...
            <div id="preview-container" class="space-y-6">
                ...
                <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
                    ...
                    <p id="preview-visi" class="text-gray-700 leading-relaxed">
                        <?php echo e($visi->content ?? 'Menjadi sekolah "tangguh dalam IMTAQ, cerdas, terampil, mandiri, berbasis Teknologi Informasi dan Komunikasi, dan berwawasan lingkungan."'); ?>
                    ...
                    <div id="preview-prestasi" class="space-y-3">
                        <?php if($prestasi && $prestasi->count() > 0): ?>
                            ...
                            <div class="bg-white rounded-lg p-4 border border-gray-200">
                                <h5 class="font-bold text-gray-900 mb-1"><?php echo e($item->title); ?></h5>
                                <p class="text-sm text-gray-600"><?php echo e($item->content); ?></p>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </div>
                ...
                <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
                    ...
                    <div id="preview-program" class="space-y-3">
                        <?php if($programs && $programs->count() > 0): ?>
                            <?php $__currentLoopData = $programs->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white rounded-lg p-4 border border-gray-200">
                                <h5 class="font-bold text-gray-900 mb-1"><?php echo e($item->title); ?></h5>
                                <p class="text-sm text-gray-600"><?php echo e($item->content); ?></p>
                            </div>
                    ...
                    <div id="preview-fasilitas" class="grid grid-cols-2 gap-3">
                        <?php if($fasilitas && $fasilitas->count() > 0): ?>
                            ...
                            <div class="bg-white rounded-lg p-3 border border-gray-200">
                                <h5 class="font-bold text-gray-900 text-sm mb-1"><?php echo e($item->title); ?></h5>
                                <p class="text-xs text-gray-600"><?php echo e($item->content); ?></p>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </div>
...
let misiCounter = <?php echo e(($misi && $misi->count() > 0) ? $misi->count() : 3); ?>;
...
function saveContent(type) {
    ...
    fetch('<?php echo e(route("admin.homepage.store")); ?>', {
        method: 'POST',
        body: formData,
        headers: {
...
function saveMisi() {
    ...
    Promise.all(misiData.map((misi, index) => {
        ...
        if (misi.id && !misi.id.startsWith('new-')) {
            ...
            return fetch('<?php echo e(route("admin.homepage.store")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
...
function saveContentItem(id, type, element) {
    ...
    const url = id ? `/admin/homepage/${id}` : '<?php echo e(route("admin.homepage.store")); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/tanziljws/Documents/backend/resources/views/admin/homepage/index.blade.php ENDPATH**/ ?>