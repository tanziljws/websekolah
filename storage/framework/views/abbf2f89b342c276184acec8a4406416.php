<?php $__env->startSection('title', 'Lupa Password - SMKN 4 BOGOR'); ?>
        ...
        <div class="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-100 p-8 md:p-10">
            ...
            <div class="mb-6 p-4 bg-green-50 border-l-4 border-green-500 rounded-xl">
                <div class="flex items-center">
                    ...
                    <p class="text-green-800 font-medium"><?php echo e(session('status')); ?></p>
                </div>
            </div>
            <?php endif; ?>
            
            <form action="<?php echo e(route('user.forgot-password')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
            ...
            <div class="mt-6 text-center">
                <a href="<?php echo e(route('user.login')); ?>" class="inline-flex items-center text-gray-600 hover:text-pink-primary transition-colors text-sm font-medium">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/tanziljws/Documents/backend/resources/views/user/forgot-password.blade.php ENDPATH**/ ?>