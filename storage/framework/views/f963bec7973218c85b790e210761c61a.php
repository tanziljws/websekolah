<?php $__env->startSection('title', 'Tambah Informasi - Admin'); ?>
<?php $__env->startSection('page-title', 'Tambah Informasi'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-900">Form Tambah Informasi</h2>
            <p class="text-sm text-gray-600 mt-1">Isi form di bawah untuk menambahkan informasi terkini baru</p>
        </div>
        
        <form action="<?php echo e(route('admin.informasi.store')); ?>" method="POST" class="p-6 space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea id="isi" name="isi" rows="8" placeholder="Tulis detail informasi..." class="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-lg text-gray-900 focus:border-pink-primary focus:ring-2 focus:ring-pink-primary focus:ring-opacity-20 transition-all duration-200 outline-none resize-none" required><?php echo e(old('isi')); ?></textarea>
                <?php $__errorArgs = ['isi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <select id="status" name="status" class="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-lg text-gray-900 focus:border-pink-primary focus:ring-2 focus:ring-pink-primary focus:ring-opacity-20 transition-all duration-200 outline-none appearance-none cursor-pointer" required>
                    <option value="published" <?php echo e(old('status', 'published') == 'published' ? 'selected' : ''); ?>>Published (Tampilkan di halaman informasi)</option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-end space-x-4 pt-4 border-t border-gray-200">
                <a href="<?php echo e(route('admin.informasi.index')); ?>" class="px-6 py-2.5 text-sm font-semibold text-gray-700 bg-white border-2 border-gray-300 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-200">
                    Batal
                </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/tanziljws/Documents/backend/resources/views/admin/informasi/create.blade.php ENDPATH**/ ?>