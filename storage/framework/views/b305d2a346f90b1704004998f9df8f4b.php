<?php $__env->startSection('title', 'Daftar - SMKN 4 BOGOR'); ?>
...
<section class="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-white to-pink-50 py-12 px-4">
    ...
    <div class="max-w-lg w-full relative z-10">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-4xl font-bold text-gray-900 mb-2">Buat Akun Baru</h1>
            <p class="text-gray-600">Bergabunglah dengan komunitas SMKN 4 BOGOR</p>
        </div>
        ...
        <div class="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-100 p-8 md:p-10">
            ...
            <form action="<?php echo e(route('user.register')); ?>" method="POST" class="space-y-5">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/tanziljws/Documents/backend/resources/views/user/register.blade.php ENDPATH**/ ?>