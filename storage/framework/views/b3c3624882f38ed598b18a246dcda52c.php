...
<nav class="bg-white shadow-md sticky top-0 z-50 border-b border-gray-100">
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center h-16">
            <!-- Logo -->
            <a href="<?php echo e(route('guest.home')); ?>" class="flex items-center space-x-3 group">
                <img src="<?php echo e(asset('logo.png')); ?>" alt="SMKN 4 BOGOR" class="h-12 w-auto object-contain transition-transform duration-300 group-hover:scale-105" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
            ...
            <div class="hidden md:flex items-center space-x-1">
                <a href="<?php echo e(route('guest.home')); ?>" 
                ...
                <a href="<?php echo e(route('guest.agenda')); ?>" 
                   class="nav-link relative px-4 py-2 text-gray-700 font-medium rounded-lg transition-all duration-300 hover:text-pink-primary hover:bg-pink-50 group">
                    <span class="relative z-10">Agenda</span>
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-pink-primary transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="<?php echo e(route('guest.informasi')); ?>" 
                   class="nav-link relative px-4 py-2 text-gray-700 font-medium rounded-lg transition-all duration-300 hover:text-pink-primary hover:bg-pink-50 group">
                    <span class="relative z-10">Informasi</span>
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-pink-primary transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="<?php echo e(route('guest.galeri')); ?>" 
                   class="nav-link relative px-4 py-2 text-gray-700 font-medium rounded-lg transition-all duration-300 hover:text-pink-primary hover:bg-pink-50 group">
...
<?php /**PATH /Users/tanziljws/Documents/backend/resources/views/components/navigation.blade.php ENDPATH**/ ?>